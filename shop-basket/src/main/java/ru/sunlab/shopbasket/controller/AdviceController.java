...
import ru.sunlab.shopbasket.exception.*;
...
public class AdviceController extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ClientNotFoundException.class, OrderNotFoundException.class,
                       BasketUnitNotFoundException.class, RabbitException.class})
    ...
    @ExceptionHandler(ProductOutOfAllStoreException.class)
    protected ResponseEntity<Object> handleProductOutOfAllStoreException(ProductOutOfAllStoreException ex){
        log.error(ex.toString());
